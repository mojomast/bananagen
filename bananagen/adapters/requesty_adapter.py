...
class RequestyAdapter:
    ...
    def __init__(self, base_url: str = "https://api.requesty.ai/v1", api_key_encrypted: str = None, provider_details: Dict = None):
    ...
    async def call_gemini(self, template_path: str, prompt: str, model: str = "google/gemini-1.5-flash", params: Dict = None) -> tuple[str, Dict]:
        """Call Gemini model via Requesty for image generation."""
        params = params or {}
        ...
        # Prepare request data for Requesty API (assumed chat/completions format similar to OpenRouter)
                ...
                async with aiohttp.ClientSession() as session:
                    async with session.post(url, headers=headers, json=request_data) as response:
                        ...
                        metadata = {
                            ...
                            "params": params,
                            "requesty_response_id": resp_json.get("id", "unknown-id"),
                            "sha256": sha256
                        }
        ...
        raise last_error or Exception("Failed to generate image via Requesty")
    ...
    def _parse_response_for_image(self, resp_json: Dict) -> bytes:
        ...
        if 'message' in choice and 'content' in choice['message']:
            ...
            # For Requesty with Gemini, the response might include image data
